    ...
    <div className="h-screen flex items-center justify-center bg-gray-100 px-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Join the AlumniConnect Community</p>
        </div>
        ...
        <div className="mb-6">
          ...
          <select
            ...
            value={formData.role}
            onChange={handleChange}
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none bg-white transition capitalize"
          >
